...
//import gmibank.utilities.Driver2;
...
//        Driver2.get().get(url);
//        Driver2.get().manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
//    }
//
//    @And("You should navigate to registration page")
//    public void youShouldNavigateToRegistrationPage() {
//        mainPage.menu.click();
//        Driver2.get().manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
...
//        registerPage.ssnTextBox.sendKeys(ssnNumber);
//        registerPage.ssnTextBox.sendKeys(Keys.ENTER);
//        Driver2.get().manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
//    }
////
...
//        boolean isPresent = Driver2.get().findElements(By.className("invalid-feedback")).size() == 8;
////        System.out.println("Size: " + Driver2.get().findElements(By.className("invalid-feedback")).size());
